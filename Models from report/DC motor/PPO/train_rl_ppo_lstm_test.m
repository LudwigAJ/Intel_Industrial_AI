%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%    Proximal-Policy-Optimisation (PPO) + LSTM v1.2        %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
criticNet = [
    ...
    lstmLayer(16,'OutputMode','sequence','Name','lstm')
...
inPath = [ 
    ...
    fullyConnectedLayer(32,'Name', 'ip_fc1')  % 16 by 1 output
    leakyReluLayer('Name', 'ip_relu1')             % nonlinearity
    fullyConnectedLayer(32,'Name', 'ip_fc2')  % 16 by 1 output
    leakyReluLayer('Name', 'ip_relu2')             % nonlinearity
    lstmLayer(16,'OutputMode','sequence','Name','lstm') % lstm
...
meanPath = [
    fullyConnectedLayer(32,'Name', 'mp_fc1') % 15 by 1 output
...
sdevPath = [
    fullyConnectedLayer(32,'Name', 'vp_fc1') % 15 by 1 output
