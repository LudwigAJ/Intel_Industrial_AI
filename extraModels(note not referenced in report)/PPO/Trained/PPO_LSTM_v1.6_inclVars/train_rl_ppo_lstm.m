%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%    Proximal-Policy-Optimisation (PPO) + LSTM v1.6        %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inPath = [ 
    ...
    fullyConnectedLayer(10,'Name', 'ip_fc1')  % 10 by 1 output
...
meanPath = [
    fullyConnectedLayer(10,'Name', 'mp_fc1') % 10 by 1 output
...
sdevPath = [
    fullyConnectedLayer(10,'Name', 'vp_fc1') % 10 by 1 output
