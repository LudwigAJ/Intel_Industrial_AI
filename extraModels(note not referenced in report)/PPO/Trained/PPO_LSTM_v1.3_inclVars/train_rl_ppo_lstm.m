%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%    Proximal-Policy-Optimisation (PPO) + LSTM v1.3        %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
meanPath = [
    fullyConnectedLayer(16,'Name', 'mp_fc1') % 16 by 1 output
...
sdevPath = [
    fullyConnectedLayer(16,'Name', 'vp_fc1') % 16 by 1 output
...
agentOpts.ExperienceHorizon = 8192;
