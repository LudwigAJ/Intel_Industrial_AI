%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%    Proximal-Policy-Optimisation (PPO) + LSTM v1.4        %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   15/06/2021 --
%   Version now includes uses the sumVoltage model specified
%   in the past changelogs.
...
mdl = 'intel_motor_control_rl_sumVoltage';
...
agentblk = 'intel_motor_control_rl_sumVoltage/Controller_equiv_DC_motor1/PI_Ctrl_float_speed/Reinforcement Learning1/RL Agent';
...
inPath = [ 
    ...
    fullyConnectedLayer(16,'Name', 'ip_fc1')  % 16 by 1 output
...
%    a file. In which case skip this and step 3.
