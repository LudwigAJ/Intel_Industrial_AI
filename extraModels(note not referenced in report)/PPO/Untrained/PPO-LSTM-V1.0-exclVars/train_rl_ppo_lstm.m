%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%    Proximal-Policy-Optimisation (PPO) + LSTM v1.0        %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inPath = [ 
    ...
    fullyConnectedLayer(16,'Name', 'ip_fc')  % 10 by 1 output
    leakyReluLayer('Name', 'ip_relu')             % nonlinearity
    lstmLayer(8,'OutputMode','sequence','Name','lstm') % lstm
